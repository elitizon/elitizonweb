  ...
  return (
    <Page>
      <Container noanimation>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Elitizon Ltd, 28 Mody Road, Room
              2203, 22/F., CFC Tower, Tsim Sha Tsui, Kowloon Hong Kong SAR
              China.
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Elitizon, accessible from{" "}
              <a
                href="https://www.elitizon.com"
              >
                https://www.elitizon.com
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            <p>By email: contact_(at)_elitizon.com</p>
          </li>
          <li>
            <p>
              By visiting this page on our website:{" "}
              <a
                href="https://www.elitizon.com/contactus"
              >
                https://www.elitizon.com/contactus
              </a>
            </p>
          </li>
        </ul>
