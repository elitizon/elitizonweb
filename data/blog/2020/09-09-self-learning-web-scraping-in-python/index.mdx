...
posttype: blog
date: 2020-09-09
summary: Despite the availability of tools such as Beautiful Soup Web Scrapping is difficult. AutoScraper is a new Python library that make the writing of scraped far more easier.
published: true
cover: ./cover.jpg
